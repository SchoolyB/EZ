...
* --emit-c writes generated C to file instead of stdout ([#2049](https://github.com/grayscale-lang/grayscale/issues/2049)) ([78281c7](https://github.com/grayscale-lang/grayscale/commit/78281c7648cfc9dcfdeaaf9cd1ec15f4a4dab952))
* add `else` as syntax alias for `otherwise` ([#1974](https://github.com/grayscale-lang/grayscale/issues/1974)) ([dc91535](https://github.com/grayscale-lang/grayscale/commit/dc91535f54d1f4907e21ec102547361dd730c2d4))
* add arrays.any() and arrays.all() higher-order functions ([#2000](https://github.com/grayscale-lang/grayscale/issues/2000)) ([c079b62](https://github.com/grayscale-lang/grayscale/commit/c079b624940b7790b3feab2137799a7e8f572bbf))
* add atomic.spinlock_destroy() to free spinlock memory ([#1721](https://github.com/grayscale-lang/grayscale/issues/1721)) ([32da8e5](https://github.com/grayscale-lang/grayscale/commit/32da8e52335bb760281762cffffb8fc365c7a239))
* add channels.try_send() and channels.try_receive() for non-blocking ops ([#2003](https://github.com/grayscale-lang/grayscale/issues/2003)) ([9ae9c02](https://github.com/grayscale-lang/grayscale/commit/9ae9c025b8623598bd7baf48de677c76d233ba71))
* add custom request headers support to http module ([#1994](https://github.com/grayscale-lang/grayscale/issues/1994)) ([d8b5c03](https://github.com/grayscale-lang/grayscale/commit/d8b5c03761f4a4b728d6faca3bd7c856a3a2b89e))
* add helpful hints to 10 common compiler error messages ([#1566](https://github.com/grayscale-lang/grayscale/issues/1566)) ([0a97a94](https://github.com/grayscale-lang/grayscale/commit/0a97a941d8063bc2ab964b0b17a75df24e97fcea))
* add os.unset_env() to remove environment variables ([#2002](https://github.com/grayscale-lang/grayscale/issues/2002)) ([b2c074d](https://github.com/grayscale-lang/grayscale/commit/b2c074d351aa2797327662f44c6456872db59259))
* add strings.char_at() to get a character at a given index ([#1998](https://github.com/grayscale-lang/grayscale/issues/1998)) ([1769f30](https://github.com/grayscale-lang/grayscale/commit/1769f30464d2dc4a00459a33842241cad403429d))
* add strings.last_index_of() to find the last occurrence of a substring ([#1996](https://github.com/grayscale-lang/grayscale/issues/1996)) ([aa1fd95](https://github.com/grayscale-lang/grayscale/commit/aa1fd95983e98001588ead8fb3d9bb6b18ef6aed))
* add strings.remove_prefix() and strings.remove_suffix() ([#1997](https://github.com/grayscale-lang/grayscale/issues/1997)) ([ab606c6](https://github.com/grayscale-lang/grayscale/commit/ab606c641587ebe1616586f8705243626f467a11))
* add strings.to_chars() and strings.from_chars() for string/char array conversion ([#1999](https://github.com/grayscale-lang/grayscale/issues/1999)) ([73bc156](https://github.com/grayscale-lang/grayscale/commit/73bc156dc07ff9e649ccadb7504b140b3549a27e))
* add time.diff() to return the difference between two timestamps ([#1993](https://github.com/grayscale-lang/grayscale/issues/1993)) ([dd007d5](https://github.com/grayscale-lang/grayscale/commit/dd007d5301be54f1b41bb40f98547da0158a3156))
* add type-level generic parameters via &lt;?&gt; syntax ([#1797](https://github.com/grayscale-lang/grayscale/issues/1797)) ([aecbdec](https://github.com/grayscale-lang/grayscale/commit/aecbdec5fa574ec8af6ae70528554877aa3cc862))
* allow compile-time integer constants as fixed-size array size specifiers ([#1958](https://github.com/grayscale-lang/grayscale/issues/1958)) ([0933931](https://github.com/grayscale-lang/grayscale/commit/09339314b0e920a0f0bc82c0d820edf1ddfff852))
* **arrays:** add map, filter, reduce higher-order functions ([#1795](https://github.com/grayscale-lang/grayscale/issues/1795)) ([706ba17](https://github.com/grayscale-lang/grayscale/commit/706ba174711a23da05af9b7e8102caba21b61be9))
* **compiler:** add tagged union enums with pattern destructuring ([#1709](https://github.com/grayscale-lang/grayscale/issues/1709)) ([2af9502](https://github.com/grayscale-lang/grayscale/commit/2af9502783e28815ed91edbd54b4af575359973b))
* **fmt:** add printfln, eprintf, eprintfln, sprintfln functions ([#1838](https://github.com/grayscale-lang/grayscale/issues/1838)) ([ac94620](https://github.com/grayscale-lang/grayscale/commit/ac9462050f5110c84a84c4832bf6d5d76572974c))
* implicit enum selector .VARIANT syntax ([#1850](https://github.com/grayscale-lang/grayscale/issues/1850)) ([61fd916](https://github.com/grayscale-lang/grayscale/commit/61fd916dcfb0ad76dc1e88aad14292f9ae2671ad))
* make `map` keyword optional — allow `[K:V]` syntax ([#1961](https://github.com/grayscale-lang/grayscale/issues/1961)) ([8546d82](https://github.com/grayscale-lang/grayscale/commit/8546d82d026d525e16b9942900a43d20dbf01d45))
* named function arguments ([639dd40](https://github.com/grayscale-lang/grayscale/commit/639dd40722fd01c6f1fbbaebaa478ada5fc1379b))
* **parser,typechecker:** support named function arguments ([#1840](https://github.com/grayscale-lang/grayscale/issues/1840)) ([52171e1](https://github.com/grayscale-lang/grayscale/commit/52171e1a904c0df6afd33bf7fc73e6ac7c598927))
* **stdlib:** add `map`, `filter`, `reduce` functions to arrays stdlib module ([3ee4f3c](https://github.com/grayscale-lang/grayscale/commit/3ee4f3cb4dbbc31de2550989305a3de5d2a9153a))
* **stdlib:** add `os.exec()` for subprocess execution with stderr capture ([c29a8f5](https://github.com/grayscale-lang/grayscale/commit/c29a8f52181ea3a462824b19f7752c73544a0b6c))
* **stdlib:** add `printfln`, `eprintf`, `eprintfln`, `sprintfln` to `fmt` stdlib module ([9b2e27a](https://github.com/grayscale-lang/grayscale/commit/9b2e27af406f8c75945de946a784f6fdebdaaffc))
* **stdlib:** add character classification functions to strings module ([#1919](https://github.com/grayscale-lang/grayscale/issues/1919)) ([4e1608a](https://github.com/grayscale-lang/grayscale/commit/4e1608a3600f7936303ef515db58ecbf257990cf))
* **stdlib:** add character classification functions to strings module ([#1919](https://github.com/grayscale-lang/grayscale/issues/1919)) ([9f172c6](https://github.com/grayscale-lang/grayscale/commit/9f172c6c24e20a018778ee4efabe7447902124fe))
* **stdlib:** add os.exec() for subprocess execution with stderr capture ([#1447](https://github.com/grayscale-lang/grayscale/issues/1447)) ([9d8741b](https://github.com/grayscale-lang/grayscale/commit/9d8741bf25721c43c57192334a2a7ee36804e2c6))
* **stdlib:** capture stdout in os.exec, return (int, string, string, bool) ([ec9eaf1](https://github.com/grayscale-lang/grayscale/commit/ec9eaf1dd5304673ba7ce9a9a16f903f38b01c70))
* struct default values ([b444ee9](https://github.com/grayscale-lang/grayscale/commit/b444ee91670779c0d779ab4eda0a19c52b579905))
* **structs:** add default field values for struct declarations ([#1794](https://github.com/grayscale-lang/grayscale/issues/1794)) ([ad26dd2](https://github.com/grayscale-lang/grayscale/commit/ad26dd2afe9622bad3bec9e33e8d6db5f5e953f6))
* support for_each over inline array literals ([#1931](https://github.com/grayscale-lang/grayscale/issues/1931)) ([cadb6a8](https://github.com/grayscale-lang/grayscale/commit/cadb6a8e6894dc27724d5f4e09a82a3b2390d6ba))
* tagged union enums with pattern destructuring ([7f66e96](https://github.com/grayscale-lang/grayscale/commit/7f66e96f1e2b3694c6c73739e4232bbb2e752c61))
* **typechecker:** add implicit enum selector .VARIANT syntax ([#1850](https://github.com/grayscale-lang/grayscale/issues/1850)) ([f154522](https://github.com/grayscale-lang/grayscale/commit/f1545224898d1786f4d508742cf411339f896fdf))
* **uuid:** add UUID struct type to uuid module ([5b92b93](https://github.com/grayscale-lang/grayscale/commit/5b92b9318af3ba9a3726be3c4faee3af7160ed2f))
* **uuid:** add UUID struct type to uuid module ([#1870](https://github.com/grayscale-lang/grayscale/issues/1870)) ([5f0b2a7](https://github.com/grayscale-lang/grayscale/commit/5f0b2a79cce0003417cb1ebec6f9599fbfe9b81e))


### Bug Fixes

* add 30s timeout to integration tests to prevent CI hangs ([a6764bf](https://github.com/grayscale-lang/grayscale/commit/a6764bf7bfc11d7b93431153950e42ddf869d4d0))
* add depth limit to json.is_valid to prevent stack overflow on deeply nested input ([#2020](https://github.com/grayscale-lang/grayscale/issues/2020)) ([0914ab7](https://github.com/grayscale-lang/grayscale/commit/0914ab70c955166ed93e90f760b4fc2760c55563))
* add missing ez_i128_to_u64 and range-check all wide-to-scalar casts ([#2029](https://github.com/grayscale-lang/grayscale/issues/2029), [#2030](https://github.com/grayscale-lang/grayscale/issues/2030)) ([f6a45ae](https://github.com/grayscale-lang/grayscale/commit/f6a45aea00c87753a01b916b1f1946c99923c68a))
* add optional host parameter to net.listen() and server.listen() to allow interface-specific binding ([#2017](https://github.com/grayscale-lang/grayscale/issues/2017)) ([63e84e6](https://github.com/grayscale-lang/grayscale/commit/63e84e6e37d01f6fd33be293064711f2a96b883e))
* add range checks to cast between int/uint and i64/u64 ([#2026](https://github.com/grayscale-lang/grayscale/issues/2026)) ([fab59e3](https://github.com/grayscale-lang/grayscale/commit/fab59e342590eeb5ca71a67670233068f302fc36))
* add runtime panic for invalid bit shift amounts ([#2025](https://github.com/grayscale-lang/grayscale/issues/2025)) ([37afcb3](https://github.com/grayscale-lang/grayscale/commit/37afcb34c51c4d151105689f35420406c8b5a423))
* add scope_destroy() to release scope memory at all typechecker call sites ([b6a1ac6](https://github.com/grayscale-lang/grayscale/commit/b6a1ac6a680402b8debe9b4d7f1812a594641147))
* add type_pool_reset() to free heap strings from type pool on shutdown ([f9ef806](https://github.com/grayscale-lang/grayscale/commit/f9ef806a08b0338d0d6766e86adf1456f650e1d9))
* add typechecker_free() and typetable_free() to release typechecker memory ([dce12dc](https://github.com/grayscale-lang/grayscale/commit/dce12dc12ab8fb72bec24c79f06b6e9da6d9fc2a))
* allow local consts as fixed-size array sizes ([#2070](https://github.com/grayscale-lang/grayscale/issues/2070)) ([e6bda10](https://github.com/grayscale-lang/grayscale/commit/e6bda100c26da2cd5d9ab2efc969c8127dd347ea))
* cap HTTP server at 1024 concurrent connections and apply 30s read timeout per connection ([#2011](https://github.com/grayscale-lang/grayscale/issues/2011)) ([7d2d30d](https://github.com/grayscale-lang/grayscale/commit/7d2d30d29b2a81cd139dddd4ec8a60c509408d46))
* cap os.exec stdout/stderr collection at 64 MiB per stream to prevent memory exhaustion ([#2010](https://github.com/grayscale-lang/grayscale/issues/2010)) ([ae9b26d](https://github.com/grayscale-lang/grayscale/commit/ae9b26db48c628769a33671682a73e39de62c7b6))
* catch channels.send/try_send type mismatch and resolve module-qualified Channel type ([#1989](https://github.com/grayscale-lang/grayscale/issues/1989)) ([e9b281c](https://github.com/grayscale-lang/grayscale/commit/e9b281cee423f40892023a86a1ad2d21cf818109))
* char/byte array literals use correct elem_size in codegen ([#2066](https://github.com/grayscale-lang/grayscale/issues/2066)) ([41c1302](https://github.com/grayscale-lang/grayscale/commit/41c1302511bf1c8f16aad80c39e10c26e15e0203))
* **ci:** remove continue-on-error from test steps ([9022bf5](https://github.com/grayscale-lang/grayscale/commit/9022bf5f54f333345e3faa6fbd7bc517b010b5cf))
* clean test .d files in make clean ([2055429](https://github.com/grayscale-lang/grayscale/commit/20554299244d9d1be3971ac76808c7b585265bd7))
* **cli:** cap update download at 256 MiB to prevent disk exhaustion ([#1980](https://github.com/grayscale-lang/grayscale/issues/1980)) ([2b14809](https://github.com/grayscale-lang/grayscale/commit/2b14809f18b3b382a3b345a635b7ac827438404c))
* **cli:** correct errors in pz server and client scaffold templates ([#1888](https://github.com/grayscale-lang/grayscale/issues/1888)) ([88c709b](https://github.com/grayscale-lang/grayscale/commit/88c709b49b426d073a5bc84f089c18d334e23b43))
* **cli:** propagate errors to main() instead of calling os.Exit directly ([c23b9e7](https://github.com/grayscale-lang/grayscale/commit/c23b9e797c7ec3322a571b057f71ba5a33f8ddb4))
* **cli:** redact home directory from C compiler path in ez report ([#1983](https://github.com/grayscale-lang/grayscale/issues/1983)) ([26eeeb0](https://github.com/grayscale-lang/grayscale/commit/26eeeb0cce7d71ae82704e5d029653d3068857a5))
* **cli:** reject path traversal sequences in ez pz project name ([#1979](https://github.com/grayscale-lang/grayscale/issues/1979)) ([badd948](https://github.com/grayscale-lang/grayscale/commit/badd948405be3979cab3aeb95de96b9d06f6302a))
* **cli:** remove unsupported sized integer/float types from ez man docs ([#1976](https://github.com/grayscale-lang/grayscale/issues/1976)) ([f660865](https://github.com/grayscale-lang/grayscale/commit/f660865924b59aa29c5a33ea48fcf9b0ae64f346))
* **cli:** replace return with exit(0) in pz cli template main() ([#1890](https://github.com/grayscale-lang/grayscale/issues/1890)) ([6ddb39c](https://github.com/grayscale-lang/grayscale/commit/6ddb39ccff271e8ef8b9fab0b28b79440caa66af))
* **cli:** restore formatEZSource for fmt unit tests ([24e28ff](https://github.com/grayscale-lang/grayscale/commit/24e28ffec5f5092940ce5f919cc6b9c5989eae9c))
* **cli:** restrict update download URLs to trusted GitHub release origin ([#1978](https://github.com/grayscale-lang/grayscale/issues/1978)) ([599f8c2](https://github.com/grayscale-lang/grayscale/commit/599f8c2f839ded18f363556c4a6e4cb117c909fa))
* **cli:** separate bare ez output from help output ([#1917](https://github.com/grayscale-lang/grayscale/issues/1917)) ([5eee078](https://github.com/grayscale-lang/grayscale/commit/5eee07853ab0c76a4964fe7cfd78eec65e020ac6))
* **codegen:** add cycle guards to prevent segfault on circular struct references ([#1784](https://github.com/grayscale-lang/grayscale/issues/1784)) ([0fbc1ac](https://github.com/grayscale-lang/grayscale/commit/0fbc1ace2f17c915e427d4f19bf88b6d98175a38))
* **codegen:** cast dividend to int64_t in div/mod overflow check to silence Wtautological-constant-out-of-range-compare ([2b753be](https://github.com/grayscale-lang/grayscale/commit/2b753be1a4b138cfdfe55246960842077c95505f))
* **codegen:** cast integer literals to int64_t in shift expressions to prevent UB for shifts &gt;= 32 ([62fd12e](https://github.com/grayscale-lang/grayscale/commit/62fd12e97805ae2cd555a741245dcb179fce5685))
* **codegen:** cast of negative float to uint/u64 now panics with P0091 ([#1964](https://github.com/grayscale-lang/grayscale/issues/1964)) ([37f4d51](https://github.com/grayscale-lang/grayscale/commit/37f4d519d5f377cb634e4ac282b6813f5af9b38a))
* **codegen:** correct uuid.generate() mapping and wire missing generate_compact ([aa28123](https://github.com/grayscale-lang/grayscale/commit/aa28123b6b01e514fc0769d83826437e66142381))
* **codegen:** deep-copy array fields from struct member access on assignment ([#1789](https://github.com/grayscale-lang/grayscale/issues/1789)) ([e1d9314](https://github.com/grayscale-lang/grayscale/commit/e1d93149548ffb3a151fa74edcf49f78cd1e6c73))
* **codegen:** emit 0 instead of {0} for scalar or_return slots ([#1882](https://github.com/grayscale-lang/grayscale/issues/1882)) ([d9e6a23](https://github.com/grayscale-lang/grayscale/commit/d9e6a233da99eba0458d83b8d7674d3af0a38726))
* **codegen:** emit bigint constructor/extractor functions for wide integer casts ([#1803](https://github.com/grayscale-lang/grayscale/issues/1803)) ([eea42c8](https://github.com/grayscale-lang/grayscale/commit/eea42c8a7c368e1b0acd750184f72bcb5b60a3dd))
* **codegen:** emit T * const for const pointer variables, not const T * ([#1937](https://github.com/grayscale-lang/grayscale/issues/1937)) ([381b662](https://github.com/grayscale-lang/grayscale/commit/381b6628d2a0b68269104a6fa4c4c1f3c4098310))
* **codegen:** escape Error return values from function arena before destruction ([#1895](https://github.com/grayscale-lang/grayscale/issues/1895)) ([8c94e57](https://github.com/grayscale-lang/grayscale/commit/8c94e5706ef69affa66e2ee203839f0970d25893))
* **codegen:** fix addr() on pointer-deref field generating invalid C ([#1785](https://github.com/grayscale-lang/grayscale/issues/1785)) ([40a1010](https://github.com/grayscale-lang/grayscale/commit/40a1010d543748a324ed3bbdae1f0b66d6a54166))
* **codegen:** fix array field indexing through struct pointer generating invalid C ([#1787](https://github.com/grayscale-lang/grayscale/issues/1787)) ([f1ad1b9](https://github.com/grayscale-lang/grayscale/commit/f1ad1b920c72f43398c53b0a9c9735dd78a7a0cb))
* **codegen:** fixed-size array [T, N] with partial init now has length N ([#1965](https://github.com/grayscale-lang/grayscale/issues/1965)) ([9810873](https://github.com/grayscale-lang/grayscale/commit/9810873d12b81884e2d1863f5667bf7be702c09e))
* **codegen:** handle default params and mutable refs in cross-module using calls ([#1872](https://github.com/grayscale-lang/grayscale/issues/1872)) ([c6ce374](https://github.com/grayscale-lang/grayscale/commit/c6ce374eda13b2d045f78aeb8f9700bb85829ad1))
* **codegen:** implicit scalar-to-bigint assignment and compound operators on wide integer types ([#1805](https://github.com/grayscale-lang/grayscale/issues/1805), [#1806](https://github.com/grayscale-lang/grayscale/issues/1806)) ([27a3356](https://github.com/grayscale-lang/grayscale/commit/27a33563a75d16685e00cb439c56b43a8b46fc6d))
* **codegen:** infer correct type for pointer dereference assignments ([#1786](https://github.com/grayscale-lang/grayscale/issues/1786)) ([a336d74](https://github.com/grayscale-lang/grayscale/commit/a336d74a548409c4fda8943c2db70b81586a610a))
* **codegen:** map compound assignment now reads existing value before applying op ([#1971](https://github.com/grayscale-lang/grayscale/issues/1971)) ([c19d6e8](https://github.com/grayscale-lang/grayscale/commit/c19d6e8c8959b5b850bda4d42788809182ae5e49))
* **codegen:** materialize rvalue arrays and maps in string interpolation ([#1894](https://github.com/grayscale-lang/grayscale/issues/1894)) ([159fd7a](https://github.com/grayscale-lang/grayscale/commit/159fd7a776d4655f54a5cc8f97f3b13411abde03))
* **codegen:** materialize rvalue maps and arrays in json.encode() ([#1898](https://github.com/grayscale-lang/grayscale/issues/1898)) ([6818385](https://github.com/grayscale-lang/grayscale/commit/6818385dae0463c6bac855f9f4cf7d6f373dc175))
* **codegen:** prefix default-value bindings to prevent variable shadowing ([#1840](https://github.com/grayscale-lang/grayscale/issues/1840)) ([bf0e393](https://github.com/grayscale-lang/grayscale/commit/bf0e393bd33e45bae229abfb653d677687c1b2c1))
* **codegen:** prevent double-wrap when assigning cast(expr, bigint) to bigint var ([#1803](https://github.com/grayscale-lang/grayscale/issues/1803)) ([e0d9ae9](https://github.com/grayscale-lang/grayscale/commit/e0d9ae93463685151720116a55a92fbac3d81554))
* **codegen:** prevent double-wrap when negating bigint variable ([676999d](https://github.com/grayscale-lang/grayscale/commit/676999d5da1453bf2b56efd68a0ee01c4f95e3c8))
* **codegen:** println(ref(x)) now prints value instead of address ([#1819](https://github.com/grayscale-lang/grayscale/issues/1819)) ([7764562](https://github.com/grayscale-lang/grayscale/commit/7764562915b6dea71ad8ecc4b9e4fe6d94f855e8))
* **codegen:** promote integer literals to double in [float]/[f32]/[f64] array literals ([#1963](https://github.com/grayscale-lang/grayscale/issues/1963)) ([c4c39b8](https://github.com/grayscale-lang/grayscale/commit/c4c39b8412462e1e7c8152a416e1f2f25f915246))
* **codegen:** recognize or_return temp prefix in fallible stdlib result checks ([#1893](https://github.com/grayscale-lang/grayscale/issues/1893)) ([1eeb0fc](https://github.com/grayscale-lang/grayscale/commit/1eeb0fc95debf3938f26aea2da488cff27609549))
* **codegen:** restore correct uuid.generate() → compact mapping ([67ddafc](https://github.com/grayscale-lang/grayscale/commit/67ddafcbd6f1ac492bce0aa53c7540dd8230eed0))
* **codegen:** size_of on literals returns correct size, type_of on inferred wide ints returns specific type ([#1809](https://github.com/grayscale-lang/grayscale/issues/1809), [#1810](https://github.com/grayscale-lang/grayscale/issues/1810)) ([191dd5e](https://github.com/grayscale-lang/grayscale/commit/191dd5e2bb327e84583136f2c490f34424c6b9e8))
* **codegen:** string(Error) now returns the error message instead of leaking C error ([#1977](https://github.com/grayscale-lang/grayscale/issues/1977)) ([72d3f2d](https://github.com/grayscale-lang/grayscale/commit/72d3f2d7a7c7a4d64bdfd481730a23057316626e))
* **codegen:** strip module prefixes from struct/enum names in println output ([9b0bcf4](https://github.com/grayscale-lang/grayscale/commit/9b0bcf4ec45cf1911ca478711ce62396120bbd49))
* **codegen:** use -&gt; instead of . when calling func reference in struct field via pointer ([#1830](https://github.com/grayscale-lang/grayscale/issues/1830)) ([6fcee13](https://github.com/grayscale-lang/grayscale/commit/6fcee1338e7b454302928c9848b900d5c4a68d81))
* **codegen:** use bare param names in default-value statement expressions ([a076141](https://github.com/grayscale-lang/grayscale/commit/a076141fdee3e99d20684507ed0cbc4d7a75418f))
* **codegen:** use bigint eq functions in when/is for wide integer types ([#1804](https://github.com/grayscale-lang/grayscale/issues/1804)) ([51089e7](https://github.com/grayscale-lang/grayscale/commit/51089e7ffc96a9d3d70b70fd65f33cddf7335e9e))
* **codegen:** use outer arena for struct deep copy inside scoped blocks ([#1880](https://github.com/grayscale-lang/grayscale/issues/1880)) ([c0140aa](https://github.com/grayscale-lang/grayscale/commit/c0140aac5abeaa698741073383ac2f63e7fb5bd1))
* **codegen:** use println_str for string enum values in println/print/eprint ([#1801](https://github.com/grayscale-lang/grayscale/issues/1801)) ([ad90143](https://github.com/grayscale-lang/grayscale/commit/ad9014313032b00aca7eb908bba894d6065c141f))
* consolidate reserved name lists into shared reserved.h ([#1954](https://github.com/grayscale-lang/grayscale/issues/1954)) ([a42a410](https://github.com/grayscale-lang/grayscale/commit/a42a41019a197e05dbd1bf3b15a69df03af3ab83))
* correct .gray extension offset and eliminate magic numbers ([#2097](https://github.com/grayscale-lang/grayscale/issues/2097)) ([76545fc](https://github.com/grayscale-lang/grayscale/commit/76545fc79aa463db81f339a91444a82ed840281e))
* correct element type parsing for nested bracket types in array initializers ([2b61fff](https://github.com/grayscale-lang/grayscale/commit/2b61fff149f65a6a4ad6bc9e714ef0f43d0c3272))
* correct lower bound in uint-to-int cast error message ([178bcf3](https://github.com/grayscale-lang/grayscale/commit/178bcf388a51f0c4de690481259182aa7d34f66b))
* E3129 compile error for empty loop bodies ([#2094](https://github.com/grayscale-lang/grayscale/issues/2094)) ([beffb89](https://github.com/grayscale-lang/grayscale/commit/beffb8965631e88d28c250263624f1d95d2b5204))
* emit correct HTTP reason phrase and Location header for redirects ([611016e](https://github.com/grayscale-lang/grayscale/commit/611016ec0ee64f1a3bddced58d4d28b3d8a6ae04))
* emit E5039 for const expression overflow, suppress C error ([#2028](https://github.com/grayscale-lang/grayscale/issues/2028)) ([1c517f1](https://github.com/grayscale-lang/grayscale/commit/1c517f1073e5a6e1714b3d7dbb08c9df164f0be8))
* emit plain cast for file-scope const sized integers ([#2095](https://github.com/grayscale-lang/grayscale/issues/2095)) ([20b7b6d](https://github.com/grayscale-lang/grayscale/commit/20b7b6defcab22467aa3cd7454b114e5fcd09b1e))
* **errors:** remove angle bracket placeholders from E3065 and E3069 error messages ([225eaef](https://github.com/grayscale-lang/grayscale/commit/225eaefced5fcba8128e97e33b47fb1bb3529ecb))
* **fmt:** implement lexer-based indentation engine for ez fmt ([984425f](https://github.com/grayscale-lang/grayscale/commit/984425ff00308b5bc251f5e804897e5f27407455))
* **fmt:** implement lexer-based indentation engine for ez fmt ([bdc0fe8](https://github.com/grayscale-lang/grayscale/commit/bdc0fe87c580a00e1d42d59f248d89ba7bda3303))
* free global_init buffer in codegen_destroy() ([6b9ea93](https://github.com/grayscale-lang/grayscale/commit/6b9ea93349af0dca1700660d2bdbdee50841aae4))
* heap-allocate builtin struct field arrays to prevent free-of-static crash ([60e273b](https://github.com/grayscale-lang/grayscale/commit/60e273bb9a4c32d241604f3164beb9efff162c6c))
* improve compiler parsing, HTTP behavior, and CLI safety ([67e1e56](https://github.com/grayscale-lang/grayscale/commit/67e1e564ccc49575ef6f59facef091ed95893bb5))
* initialize ns_func_names fields in codegen_create to prevent garbage free ([1ab0464](https://github.com/grayscale-lang/grayscale/commit/1ab0464c95d21b36884fb5745b0fc58d4944fa64))
* json.encode always quotes map[string:string] values, escape all control chars ([#2019](https://github.com/grayscale-lang/grayscale/issues/2019)) ([c490066](https://github.com/grayscale-lang/grayscale/commit/c490066a89efd5224aede9e83487c3b9f40aa828))
* **leaks:** print clear PASS/FAIL summary at end of make leaks output ([#1975](https://github.com/grayscale-lang/grayscale/issues/1975)) ([141b947](https://github.com/grayscale-lang/grayscale/commit/141b947b90d10ab539dc3ca8fec947f76e957998))
* **lexer:** catch physical newline in string literal as E1023 ([#1959](https://github.com/grayscale-lang/grayscale/issues/1959)) ([683203b](https://github.com/grayscale-lang/grayscale/commit/683203b013b038ea2e041d3aa07f4857bc0d96f3))
* **main:** suppress ld warnings from cc link command with -Wl,-w ([3ab0df7](https://github.com/grayscale-lang/grayscale/commit/3ab0df775f07e195e61fa42da485df18ceb7e74e))
* **main:** use fork+execv instead of system() in run mode ([#1285](https://github.com/grayscale-lang/grayscale/issues/1285)) ([f36dab9](https://github.com/grayscale-lang/grayscale/commit/f36dab9251fcf4388b9f9aacc73833b62f16d4cb))
* materialize rvalue for map field access through explicit ptr deref ([#2065](https://github.com/grayscale-lang/grayscale/issues/2065)) ([353b16c](https://github.com/grayscale-lang/grayscale/commit/353b16c3547984450394601b27ab683a15969451))
* overflow-check range loop step increment ([#2027](https://github.com/grayscale-lang/grayscale/issues/2027)) ([248316f](https://github.com/grayscale-lang/grayscale/commit/248316f996f004857b8b6efbb6a9ba49e10e401d))
* panic P0090 on range() zero step instead of hanging ([#1924](https://github.com/grayscale-lang/grayscale/issues/1924)) ([#1933](https://github.com/grayscale-lang/grayscale/issues/1933)) ([efb9739](https://github.com/grayscale-lang/grayscale/commit/efb9739825739ee4820734d86ddd8567b6e9126b))
* parse fixed-size array of maps type annotation [map[K:V], N] ([1b183d1](https://github.com/grayscale-lang/grayscale/commit/1b183d16cab357b796e6c86f1c73c8a266f9f89b))
* **parser,codegen:** allow bare func as map value type ([#1831](https://github.com/grayscale-lang/grayscale/issues/1831)) ([0b6163f](https://github.com/grayscale-lang/grayscale/commit/0b6163fb065a85038798ba9f5400e3db777694a7))
* **parser:** accept complex types in multi-return destructuring positions 2+ ([#1962](https://github.com/grayscale-lang/grayscale/issues/1962)) ([a2b0454](https://github.com/grayscale-lang/grayscale/commit/a2b0454d0eb523e95a154565627300a2caed7b7e))
* **parser:** also reject reserved type names as struct field names ([#1859](https://github.com/grayscale-lang/grayscale/issues/1859)) ([62ca179](https://github.com/grayscale-lang/grayscale/commit/62ca179e3d5afe6b4acd37130be75e3fdce493ba))
* **parser:** backfill default values across grouped params ([#1823](https://github.com/grayscale-lang/grayscale/issues/1823)) ([ce8b999](https://github.com/grayscale-lang/grayscale/commit/ce8b9996c9daf2470c532d75007d3664feebfe8c))
* **parser:** emit E2086 when in/not_in/!in has no left-hand value ([#1960](https://github.com/grayscale-lang/grayscale/issues/1960)) ([de90608](https://github.com/grayscale-lang/grayscale/commit/de906080604f2534a3cdeb30952a3e4eea3ae919))
* **parser:** enforce separate lines for all struct fields and enum variants ([#1867](https://github.com/grayscale-lang/grayscale/issues/1867)) ([f50b5c3](https://github.com/grayscale-lang/grayscale/commit/f50b5c3ae1e6ed2c6c4fee3b4e9a10aadad4777e))
* **parser:** reject blank identifier declarations missing '=' ([#1878](https://github.com/grayscale-lang/grayscale/issues/1878)) ([c7ec8ad](https://github.com/grayscale-lang/grayscale/commit/c7ec8adb3517c753a6b98aa3ef73afc30c122db5))
* **parser:** reject postfix ^ in return type with E2081 ([223e3c7](https://github.com/grayscale-lang/grayscale/commit/223e3c763801305e51961f8f48f3182dc83cc906))
* **parser:** reject reserved keywords as struct field names ([#1859](https://github.com/grayscale-lang/grayscale/issues/1859)) ([db595c5](https://github.com/grayscale-lang/grayscale/commit/db595c57f1b6af856355c2ede54592c828d92737))
* **parser:** reject typed func signature as array element type with E2082 ([e6882a8](https://github.com/grayscale-lang/grayscale/commit/e6882a800460b9a5744ec290bef5ef2a2a145ed6))
* **parser:** restrict 'for x in' to range() and add for_each shadowing warning ([d3b4384](https://github.com/grayscale-lang/grayscale/commit/d3b4384d1ea71329e79b09288fb05eef36b6733c))
* **parser:** support blank identifier _ as for loop variable in range iteration ([#1972](https://github.com/grayscale-lang/grayscale/issues/1972)) ([3dc99b3](https://github.com/grayscale-lang/grayscale/commit/3dc99b3de1428de7cc4f7ccf64571288576caddd))
* **parser:** support custom fallback values in or_return ([#1808](https://github.com/grayscale-lang/grayscale/issues/1808)) ([da9f01d](https://github.com/grayscale-lang/grayscale/commit/da9f01dd5a88a88725066fc89ac2875320f00434))
* pointer/struct bug fixes ([4f72660](https://github.com/grayscale-lang/grayscale/commit/4f72660d844535c23966e842eda48fdc6bb1fdb6))
* prompt for confirmation before ez pz --force deletes existing directory ([d34a65c](https://github.com/grayscale-lang/grayscale/commit/d34a65cd5e856085b5ace77923e43f2f9dedd3cd))
* reject addr() on const variables with E3122 ([#1930](https://github.com/grayscale-lang/grayscale/issues/1930)) ([de5f604](https://github.com/grayscale-lang/grayscale/commit/de5f604979b09fb3ae7fda17539b2611ca1426dc))
* reject channels.try_receive() single capture with E3040 instead of C error leak ([#2060](https://github.com/grayscale-lang/grayscale/issues/2060)) ([04d0864](https://github.com/grayscale-lang/grayscale/commit/04d0864f7ef680b9524c4a8d776048529be1fd82))
* reject copy() on pointer types with E5037 ([#1928](https://github.com/grayscale-lang/grayscale/issues/1928)) ([#1936](https://github.com/grayscale-lang/grayscale/issues/1936)) ([c7a8fac](https://github.com/grayscale-lang/grayscale/commit/c7a8face9aa9655fe9c5335f4099f14817fb8150))
* reject CORS origins containing CR or LF to prevent HTTP header injection (P0101) ([#2009](https://github.com/grayscale-lang/grayscale/issues/2009)) ([3188d1d](https://github.com/grayscale-lang/grayscale/commit/3188d1d7ab7b176136ae71ecc5532d0087b743e8))
* reject duplicate default branches in when statements with E2085 ([#1926](https://github.com/grayscale-lang/grayscale/issues/1926)) ([#1935](https://github.com/grayscale-lang/grayscale/issues/1935)) ([1074521](https://github.com/grayscale-lang/grayscale/commit/10745214f5f5d75aa7a5034e5c803e9579d3198f))
* reject https:// URLs in http module with explicit error instead of silent plaintext fallback ([#2007](https://github.com/grayscale-lang/grayscale/issues/2007)) ([b25c633](https://github.com/grayscale-lang/grayscale/commit/b25c633b6812c83b3d92c526d4a2acfff4609f6a))
* reject incompatible bigint types in arithmetic and comparison ([#2004](https://github.com/grayscale-lang/grayscale/issues/2004)) ([ab27912](https://github.com/grayscale-lang/grayscale/commit/ab27912ac303e574124722ec07e02193e28d55e3))
* reject nil comparison with non-pointer types with E3092 ([#1929](https://github.com/grayscale-lang/grayscale/issues/1929)) ([a903d7c](https://github.com/grayscale-lang/grayscale/commit/a903d7c8b6f204d4236b5c453a569e322028e50f))
* reject pointer ordering comparisons with E3120 ([#1923](https://github.com/grayscale-lang/grayscale/issues/1923)) ([#1932](https://github.com/grayscale-lang/grayscale/issues/1932)) ([f035594](https://github.com/grayscale-lang/grayscale/commit/f0355947944d75c29592cf52f861224cbbe8db2e))
* reject string index assignment with E3004 instead of leaking C error ([#2005](https://github.com/grayscale-lang/grayscale/issues/2005)) ([594dd13](https://github.com/grayscale-lang/grayscale/commit/594dd1351b270fd2fc675221ef9405a9b62df768))
* reject struct, array, map, and pointer as when conditions with E3121 ([#1925](https://github.com/grayscale-lang/grayscale/issues/1925)) ([#1934](https://github.com/grayscale-lang/grayscale/issues/1934)) ([2ca1702](https://github.com/grayscale-lang/grayscale/commit/2ca170218e7bcf81379e6ff59aede37f18ab2c98))
* repair result-clobbering NULL and dangling stack pointers in typechecker ([#2040](https://github.com/grayscale-lang/grayscale/issues/2040), [#2045](https://github.com/grayscale-lang/grayscale/issues/2045)) ([e74831a](https://github.com/grayscale-lang/grayscale/commit/e74831a2218effa27963f1924316f3890bdfc90e))
* report 'unexpected end of interpolation expression' instead of EOF in ${...} sub-parser ([#2018](https://github.com/grayscale-lang/grayscale/issues/2018)) ([ef0369d](https://github.com/grayscale-lang/grayscale/commit/ef0369d46d8806bd43127dadb5803935a93402d6))
* resolve rvalue address-of bug in stdlib codegen ([#2053](https://github.com/grayscale-lang/grayscale/issues/2053), [#2052](https://github.com/grayscale-lang/grayscale/issues/2052)) ([2657125](https://github.com/grayscale-lang/grayscale/commit/2657125851c6e9b75bcccc6b3463071999570557))
* resolve string enum element type in array indexing and iteration ([1a0956a](https://github.com/grayscale-lang/grayscale/commit/1a0956a2fb21c16bb3871a2774411c1e779f7a07))
* resolve wildcard-returned enums as TK_ENUM instead of TK_STRUCT ([#2054](https://github.com/grayscale-lang/grayscale/issues/2054)) ([a90e756](https://github.com/grayscale-lang/grayscale/commit/a90e756db0e24193af8c65173ee010613c6481d1))
* **runtime:** drain overlong input() lines to prevent stdin contamination ([#1981](https://github.com/grayscale-lang/grayscale/issues/1981)) ([0576927](https://github.com/grayscale-lang/grayscale/commit/057692798834c959f4b128fd0c2d3229dcb42b75))
* **runtime:** use pre-addition overflow check in ez_string_concat to eliminate signed UB ([#1984](https://github.com/grayscale-lang/grayscale/issues/1984)) ([c1af77d](https://github.com/grayscale-lang/grayscale/commit/c1af77d7bbda0ea927467d02c10fda383001c419))
* **runtime:** use source file paths in panic messages instead of generated C paths ([560ceec](https://github.com/grayscale-lang/grayscale/commit/560ceec805d0c4bc271c2a657960a425d05edcce))
* **scripts:** handle escaped quotes in error message extraction ([790e2cf](https://github.com/grayscale-lang/grayscale/commit/790e2cf079d895f3fe328a668c59aa21ca00a602))
* send HTTP request headers and body separately to remove 8KB body size limit ([#2013](https://github.com/grayscale-lang/grayscale/issues/2013)) ([8df4f3e](https://github.com/grayscale-lang/grayscale/commit/8df4f3edfbb94298d3bb67b937bc8aff03983121))
* **stdlib:** remove function name aliases csv.decode, csv.format, json.format ([189b7f1](https://github.com/grayscale-lang/grayscale/commit/189b7f1e261a9b377ceb23309c14f13f742973ec))
* strdup type_array inputs and resolve remaining free-of-non-heap crashes ([ca7aa46](https://github.com/grayscale-lang/grayscale/commit/ca7aa46dffcc595affb2cf3b5e24f991ae73d4a8))
* strip \$ escape in codegen so escaped interpolation emits valid C ([#2077](https://github.com/grayscale-lang/grayscale/issues/2077)) ([da10377](https://github.com/grayscale-lang/grayscale/commit/da103771d39627a21b919c41aa14203e0b250126))
* **tests:** remove cast(string, int) test case from cast_keyword (rejected by E3043) ([3639475](https://github.com/grayscale-lang/grayscale/commit/3639475e813c8813fa5ea20ad308ae32c40ee78b))
* **tests:** remove cast(string, int/float) test cases from cast_conversions (rejected by E3043) ([780e9bb](https://github.com/grayscale-lang/grayscale/commit/780e9bb877b788c146429976dea5d8181a210e07))
* **tests:** remove stale E3042 unit and integration tests ([a076141](https://github.com/grayscale-lang/grayscale/commit/a076141fdee3e99d20684507ed0cbc4d7a75418f))
* **tests:** remove stale E3042 unit test ([28bc4a0](https://github.com/grayscale-lang/grayscale/commit/28bc4a024be6509b956c86ca35a145d45c9f84f9))
* **tests:** replace httpbin.org with httpbun.com for reliable CI ([6989944](https://github.com/grayscale-lang/grayscale/commit/69899447a0a153e33e716e4386dea79ec3e0c1f1))
* **tests:** update enum tests ([#1885](https://github.com/grayscale-lang/grayscale/issues/1885)) ([a56358d](https://github.com/grayscale-lang/grayscale/commit/a56358d67060680a66b6bf4c58754ede589470c0))
* **tests:** update func ref tests to use const and remove invalid reassign test ([4558676](https://github.com/grayscale-lang/grayscale/commit/45586765cdceab92b50bb6787e5344f24aebe3f5))
* **tests:** update tests using reserved builtin/stdlib/type names ([7987209](https://github.com/grayscale-lang/grayscale/commit/798720984a444c504b3a4a5b963aeb67bb1d90bd))
* **tests:** use typed enum array in stress_enums (correct element sizing) ([69341e3](https://github.com/grayscale-lang/grayscale/commit/69341e3724a65b4591a1404da4bfc0207553c1c9))
* track and free struct-namespaced function name strings in codegen ([480c807](https://github.com/grayscale-lang/grayscale/commit/480c80772fc1de968ec7511e1067514b0c80377d))
* track wide integers in const table and emit compound literals at file scope ([#2096](https://github.com/grayscale-lang/grayscale/issues/2096)) ([de4ed9b](https://github.com/grayscale-lang/grayscale/commit/de4ed9b4d952b43e8ab9c3de48d16c2e7c5337e8))
* typecheck index argument in arrays.remove_at() and arrays.insert_at() ([97f4244](https://github.com/grayscale-lang/grayscale/commit/97f4244f82a667f2076b9e1b12abe2d8e46a2bae))
* typechecker & parser improvements ([7b42747](https://github.com/grayscale-lang/grayscale/commit/7b427476c577e5207d111477f1a20ba14059582e))
* **typechecker,codegen:** restore string enum ↔ string interop ([#1801](https://github.com/grayscale-lang/grayscale/issues/1801)) ([f67c08d](https://github.com/grayscale-lang/grayscale/commit/f67c08d9006fb9147d4e18022a0e4af7e9e9943f))
* **typechecker,codegen:** string enum type tracking and comparisons ([#1801](https://github.com/grayscale-lang/grayscale/issues/1801)) ([158a6c9](https://github.com/grayscale-lang/grayscale/commit/158a6c9f0901ca6beb859f9c93adc0498dea1a95))
* **typechecker:** accept stdlib struct types in struct field declarations ([#1870](https://github.com/grayscale-lang/grayscale/issues/1870)) ([5ede4d1](https://github.com/grayscale-lang/grayscale/commit/5ede4d150f3583d0fa12dec2f6e3f34ada4eab2d))
* **typechecker:** account for default params in cross-module function calls ([#1872](https://github.com/grayscale-lang/grayscale/issues/1872)) ([cc7c6cd](https://github.com/grayscale-lang/grayscale/commit/cc7c6cdbfea7fd612f8198fb68af1afc35723020))
* **typechecker:** add missing arg type validation for strings stdlib functions ([#1875](https://github.com/grayscale-lang/grayscale/issues/1875)) ([308108a](https://github.com/grayscale-lang/grayscale/commit/308108ab1d163ee8e45da838af344adbced177bf))
* **typechecker:** add stdlib arg count and type validation for math, maps, mem, threads, sync, channels, atomic, fmt, server ([#1918](https://github.com/grayscale-lang/grayscale/issues/1918)) ([65818c9](https://github.com/grayscale-lang/grayscale/commit/65818c9992a0e31f19008b8239d1a1eecb9de418))
* **typechecker:** add W3005 and W3006 warnings for unsafe when statement patterns ([55bcfe7](https://github.com/grayscale-lang/grayscale/commit/55bcfe7b6271291b3e5006fe87e2fa1f8b2693ff))
* **typechecker:** allow instance dispatch for all struct functions ([#1848](https://github.com/grayscale-lang/grayscale/issues/1848)) ([367ef74](https://github.com/grayscale-lang/grayscale/commit/367ef744231f1f5ca6436466688e3ec450f43b59))
* **typechecker:** allow range(n, n) as empty sequence per spec start &lt;= end ([#1969](https://github.com/grayscale-lang/grayscale/issues/1969)) ([f4683f9](https://github.com/grayscale-lang/grayscale/commit/f4683f9e0415d69f55e756945301c2821f1e72c4))
* **typechecker:** block builtin and stdlib names from all identifier positions ([#1859](https://github.com/grayscale-lang/grayscale/issues/1859)) ([3fbb037](https://github.com/grayscale-lang/grayscale/commit/3fbb037c8d3454e558b4a1d8efb84bfeedd80bf0))
* **typechecker:** catch struct type mismatch in pointer dereference assignment ([#1788](https://github.com/grayscale-lang/grayscale/issues/1788)) ([8019d7a](https://github.com/grayscale-lang/grayscale/commit/8019d7add8d0f84e387bcd5a8cf08b594338ef7b))
* **typechecker:** catch struct type mismatch in struct field assignment and nested literals ([#1790](https://github.com/grayscale-lang/grayscale/issues/1790)) ([f5b015b](https://github.com/grayscale-lang/grayscale/commit/f5b015b393e0a127bf7f98bca9238ee2a974ba8a))
* **typechecker:** catch struct/enum type names used as value arguments ([#1797](https://github.com/grayscale-lang/grayscale/issues/1797)) ([6f2ac19](https://github.com/grayscale-lang/grayscale/commit/6f2ac197809cd565ac92af3b7110926631dab727))
* **typechecker:** compare display names for cross-module struct/enum type matching ([#1873](https://github.com/grayscale-lang/grayscale/issues/1873)) ([3165652](https://github.com/grayscale-lang/grayscale/commit/3165652112166b20abac2602b9788fd0a3434ab3))
* **typechecker:** enforce private on struct function references ([#1835](https://github.com/grayscale-lang/grayscale/issues/1835)) ([3b82944](https://github.com/grayscale-lang/grayscale/commit/3b829443e148c89b493a591132f376b80aab8be3))
* **typechecker:** fix segfault from null result in tc_lookup_using_constant ([#1912](https://github.com/grayscale-lang/grayscale/issues/1912)) ([971760c](https://github.com/grayscale-lang/grayscale/commit/971760cf1658be4c1d33804b4765c4b44acd7692))
* **typechecker:** prevent transitive import type leaking ([bc37dd9](https://github.com/grayscale-lang/grayscale/commit/bc37dd96291701167dcf788fa4c68d91011c670e))
* **typechecker:** reject == / != on tagged enums with E3124 ([#1967](https://github.com/grayscale-lang/grayscale/issues/1967)) ([ce02e3e](https://github.com/grayscale-lang/grayscale/commit/ce02e3e714ef1caabe999ef044d4d1bf34552428))
* **typechecker:** reject arithmetic and ordering on enum variables ([#1858](https://github.com/grayscale-lang/grayscale/issues/1858)) ([0cb5d15](https://github.com/grayscale-lang/grayscale/commit/0cb5d15bd49ba61ca724c673c8282b03a69b7048))
* **typechecker:** reject arrays.contains() with struct element types ([#1901](https://github.com/grayscale-lang/grayscale/issues/1901)) ([a3e2ef4](https://github.com/grayscale-lang/grayscale/commit/a3e2ef47f2b39ee40b7252b2eeaf85ea54faa13e))
* **typechecker:** reject cast(string, int/float/uint) with E3043 ([#1807](https://github.com/grayscale-lang/grayscale/issues/1807)) ([c5294c3](https://github.com/grayscale-lang/grayscale/commit/c5294c35fe7cfdc854f5cda9326e154bf840c442))
* **typechecker:** reject comparison of different enum types ([#1865](https://github.com/grayscale-lang/grayscale/issues/1865)) ([f64aa67](https://github.com/grayscale-lang/grayscale/commit/f64aa6799f3e65f4c3b7d9131284489d840ffec9))
* **typechecker:** reject copy() on func references ([#1820](https://github.com/grayscale-lang/grayscale/issues/1820)) ([77cca61](https://github.com/grayscale-lang/grayscale/commit/77cca61161c8d21fe24fda38433dfd783b016341))
* **typechecker:** reject enum constants passed to mutable parameters ([#1844](https://github.com/grayscale-lang/grayscale/issues/1844)) ([0e7f608](https://github.com/grayscale-lang/grayscale/commit/0e7f608c070f9fe7d9ee98cb905a397b6f26451b))
* **typechecker:** reject fixed-size array types in function parameters ([#1892](https://github.com/grayscale-lang/grayscale/issues/1892)) ([257dfda](https://github.com/grayscale-lang/grayscale/commit/257dfda91c48b464d74210c0b7058838140e6c5b))
* **typechecker:** reject fmt.println as unknown fmt function ([b964d64](https://github.com/grayscale-lang/grayscale/commit/b964d641a35410cc696d9de776367122a2b4e833))
* **typechecker:** reject for_each with both positions as _ with E3123 ([#1966](https://github.com/grayscale-lang/grayscale/issues/1966)) ([7bda22b](https://github.com/grayscale-lang/grayscale/commit/7bda22b7103d037b3e3a1beefadbc49332641b44))
* **typechecker:** reject func references passed to print functions ([#1821](https://github.com/grayscale-lang/grayscale/issues/1821)) ([f49a271](https://github.com/grayscale-lang/grayscale/commit/f49a27126d7617b3f9e7dc99ec4e87a37fc121a0))
* **typechecker:** reject func references to builtin and stdlib functions ([#1832](https://github.com/grayscale-lang/grayscale/issues/1832)) ([2306015](https://github.com/grayscale-lang/grayscale/commit/23060154f7215a3bf31f865daa2e680f43f5ad44))
* **typechecker:** reject func-type return values assigned to variables and chained calls ([#1829](https://github.com/grayscale-lang/grayscale/issues/1829)) ([1e70edf](https://github.com/grayscale-lang/grayscale/commit/1e70edf790e4582137acf0b35d860be987c0b166))
* **typechecker:** reject func-typed fields on #json structs ([#1836](https://github.com/grayscale-lang/grayscale/issues/1836)) ([63746f3](https://github.com/grayscale-lang/grayscale/commit/63746f355497fbbbc5b7e8bdef76f5ac69f24b91))
* **typechecker:** reject integer comparison and assignment with enum types ([#1884](https://github.com/grayscale-lang/grayscale/issues/1884)) ([ad2334e](https://github.com/grayscale-lang/grayscale/commit/ad2334e818b6b2897c9e275960e2d5842e5c8ee7))
* **typechecker:** reject maps.contains_value() with struct value types ([#1902](https://github.com/grayscale-lang/grayscale/issues/1902)) ([1d1774c](https://github.com/grayscale-lang/grayscale/commit/1d1774ceb96aae47dd7f62059789706634b9ac29))
* **typechecker:** reject mismatched func ref assigned to struct field ([#1822](https://github.com/grayscale-lang/grayscale/issues/1822)) ([c675fee](https://github.com/grayscale-lang/grayscale/commit/c675fee42ec225c3270743c8b34f2ffdc72afa40))
* **typechecker:** reject mismatched func ref in typed return statement ([#1817](https://github.com/grayscale-lang/grayscale/issues/1817)) ([2459c5b](https://github.com/grayscale-lang/grayscale/commit/2459c5b0e989f4891f4f4c9572a6cf10b431da0d))
* **typechecker:** reject mixed enum types in array literals ([#1862](https://github.com/grayscale-lang/grayscale/issues/1862)) ([0838368](https://github.com/grayscale-lang/grayscale/commit/0838368bce6d6c62c10f528269a3198bac370583))
* **typechecker:** reject multi-return destructuring with too few variables ([#1860](https://github.com/grayscale-lang/grayscale/issues/1860)) ([afbad4c](https://github.com/grayscale-lang/grayscale/commit/afbad4c32abfeff4bf621a7ef545b883deecf341))
* **typechecker:** reject mut on func reference variable declarations ([#1818](https://github.com/grayscale-lang/grayscale/issues/1818)) ([2271ba4](https://github.com/grayscale-lang/grayscale/commit/2271ba41077c11aefa9b3bbf2bfb0dc4277b4b10))
* **typechecker:** reject reserved stdlib type names as struct names ([#1791](https://github.com/grayscale-lang/grayscale/issues/1791)) ([9f4c4ac](https://github.com/grayscale-lang/grayscale/commit/9f4c4ac7a8efe8a96cb404fd65bf5f68051aa99d))
* **typechecker:** reject return of wrong enum type ([#1864](https://github.com/grayscale-lang/grayscale/issues/1864)) ([3f5fb02](https://github.com/grayscale-lang/grayscale/commit/3f5fb0205af099354f66954e4c8402cfbb4f3dc2))
* **typechecker:** reject sized integer and float type names used as function calls ([#1896](https://github.com/grayscale-lang/grayscale/issues/1896)) ([fb3570f](https://github.com/grayscale-lang/grayscale/commit/fb3570f34a39a0b4eea3450ddafc798f885def3e))
* **typechecker:** reject string() on array, map, struct, pointer with E3043 ([#1853](https://github.com/grayscale-lang/grayscale/issues/1853), [#1854](https://github.com/grayscale-lang/grayscale/issues/1854)) ([f4146fa](https://github.com/grayscale-lang/grayscale/commit/f4146faebe8387b2d58819498e11394bcd507427))
* **typechecker:** reject string() on string values with E3043 ([#1852](https://github.com/grayscale-lang/grayscale/issues/1852)) ([f3d42ee](https://github.com/grayscale-lang/grayscale/commit/f3d42ee50e9be6267003e033528d922861d66938))
* **typechecker:** reject struct functions declared on #json structs ([#1837](https://github.com/grayscale-lang/grayscale/issues/1837)) ([962cc8f](https://github.com/grayscale-lang/grayscale/commit/962cc8fa60e1e2e19a033a6eb9c9cb9978c4325e))
* **typechecker:** reject tagged enum passed to print functions with E5038 ([#1968](https://github.com/grayscale-lang/grayscale/issues/1968)) ([d83c720](https://github.com/grayscale-lang/grayscale/commit/d83c720edf9a3bd92d384fb716d290be49357c97))
* **typechecker:** reject unknown directives, arg count mismatches, and dangling % in fmt format strings ([#1839](https://github.com/grayscale-lang/grayscale/issues/1839)) ([e306837](https://github.com/grayscale-lang/grayscale/commit/e30683734c6d5a42078c9ea5d390ecce2421a5fc))
* **typechecker:** reject wrong enum type in map literal keys and values ([#1863](https://github.com/grayscale-lang/grayscale/issues/1863)) ([1b6d845](https://github.com/grayscale-lang/grayscale/commit/1b6d8459cd0c55785e4a83348c239478f185fdb6))
* **typechecker:** remove phantom arrays.insert, set, and sum functions ([13f6214](https://github.com/grayscale-lang/grayscale/commit/13f621405839599ab9bcc34afa6660e4f69edb19))
* **typechecker:** remove phantom math.mod/pi/e/tau function registrations ([b952bc0](https://github.com/grayscale-lang/grayscale/commit/b952bc0df01db20836f429962e11fdc9809a64fc))
* **typechecker:** remove phantom threads.sleep_s/sleep_ms/sleep_ns — sleep() is the only threads sleep, _s/_ms/_ns are builtins ([ab8d7bd](https://github.com/grayscale-lang/grayscale/commit/ab8d7bde15a096159d983f756982db41be259b10))
* **typechecker:** replace misleading 'only structs' phrasing in E3013 messages ([b0d1695](https://github.com/grayscale-lang/grayscale/commit/b0d1695160eeee23de1f1130db04188a9610ca36))
* **typechecker:** resolve imported constants in global array initializers ([611d3f2](https://github.com/grayscale-lang/grayscale/commit/611d3f246f2d0eceefe601106bc052cb9ec811ee))
* **typechecker:** skip early resolve for implicit enum args, propagate array-of-enum expected_type ([#1850](https://github.com/grayscale-lang/grayscale/issues/1850)) ([acc0857](https://github.com/grayscale-lang/grayscale/commit/acc08573c641fc2961cf27d979410642c28b93db))
* **typechecker:** skip false-positive E3001 when wildcard arg is unresolved in main pass ([3b2d2fb](https://github.com/grayscale-lang/grayscale/commit/3b2d2fb7a751262520fe4e219cf80c15a53ef0fc))
* **typechecker:** string enum interop with when/is, return types, and array element assignment ([#1801](https://github.com/grayscale-lang/grayscale/issues/1801)) ([1ccf16a](https://github.com/grayscale-lang/grayscale/commit/1ccf16a57312470f0d3446c9c186beeef0cca9cf))
* **typechecker:** strip module prefix from struct name in all error messages ([#1866](https://github.com/grayscale-lang/grayscale/issues/1866)) ([25aff14](https://github.com/grayscale-lang/grayscale/commit/25aff1451688664729c5e46fd266f2dc2e6d4717))
* **typechecker:** strip module prefixes from user-facing error messages ([cfeffde](https://github.com/grayscale-lang/grayscale/commit/cfeffde793b6ea0935ac0e0f52b5e6c54854d716))
* **typechecker:** unify struct array types across imported files ([#1879](https://github.com/grayscale-lang/grayscale/issues/1879)) ([ab424fe](https://github.com/grayscale-lang/grayscale/commit/ab424fe8a83b8205bf8c780721f8d2a2697ee201))
* **typechecker:** use type_display_name in struct function arg errors ([#1866](https://github.com/grayscale-lang/grayscale/issues/1866)) ([8c4af9a](https://github.com/grayscale-lang/grayscale/commit/8c4af9ad2649845ddeae699e2a3f64bfa625881d))
* **typechecker:** validate argument types for server response builder functions ([#1887](https://github.com/grayscale-lang/grayscale/issues/1887)) ([4c62066](https://github.com/grayscale-lang/grayscale/commit/4c62066e3df7c6e5e1f8dc624063496f18a37761))
* **typechecker:** validate io.write_file and io.append_file content arg type ([dcf4b61](https://github.com/grayscale-lang/grayscale/commit/dcf4b61f015016f7c13a8b076c3815452604c264))
* **typechecker:** validate mutable params in instance dispatch path ([#1845](https://github.com/grayscale-lang/grayscale/issues/1845)) ([fb98a9c](https://github.com/grayscale-lang/grayscale/commit/fb98a9ca6a24a4a76c40b73872eeb3c600941701))
* **typechecker:** warn when function parameter shadows enum variant ([#1861](https://github.com/grayscale-lang/grayscale/issues/1861)) ([26f8e1d](https://github.com/grayscale-lang/grayscale/commit/26f8e1d19913e856ce259d372d9db306f0d25d52))
* use arena allocation for named-arg reorder buffer in tc_resolve_named_args() ([58cc8b4](https://github.com/grayscale-lang/grayscale/commit/58cc8b4aad74b134fec8db07566a8b30472e50c7))
* use correct C type for integer enum array element access ([bb62a4a](https://github.com/grayscale-lang/grayscale/commit/bb62a4a37b72b85bc7fd00bda908b5456d9195d2))
* use lvalue check in addr-of wrapping to preserve mutation semantics ([#2053](https://github.com/grayscale-lang/grayscale/issues/2053), [#2052](https://github.com/grayscale-lang/grayscale/issues/2052)) ([c8becba](https://github.com/grayscale-lang/grayscale/commit/c8becbaf1d4e5f61c0ec77ed195aa9cd32f6caa3))
* validate Channel type for first arg of all channels functions ([#2061](https://github.com/grayscale-lang/grayscale/issues/2061)) ([e9269d2](https://github.com/grayscale-lang/grayscale/commit/e9269d258729ab3eef0be8d8c24cc6afe5311f34))
* warn when ez doc --output writes outside the current directory ([83adb16](https://github.com/grayscale-lang/grayscale/commit/83adb1661159d57bddfc0dcc0a8a030b18d60b3a))


### Performance Improvements

* add early-out for equal names in tc_same_enum_type and tc_same_struct_type ([#2043](https://github.com/grayscale-lang/grayscale/issues/2043)) ([79d9dc3](https://github.com/grayscale-lang/grayscale/commit/79d9dc3e73d0e92f6b25b60e3921c0bd4cadc11a))
* add parallel index array to find_enum_index to eliminate O(n) scan after bsearch ([#2042](https://github.com/grayscale-lang/grayscale/issues/2042)) ([963cbfc](https://github.com/grayscale-lang/grayscale/commit/963cbfca6da9f3bc3f69bd85bd02295cf7b4ac0d))
* cache tc_lookup_using_constant result to avoid double call ([#2040](https://github.com/grayscale-lang/grayscale/issues/2040)) ([180d0d7](https://github.com/grayscale-lang/grayscale/commit/180d0d794fc002cade869c814b34f38a116dd86c))
* **codegen:** collapse buf_append_indent loop into a single buf_appendn call ([#1953](https://github.com/grayscale-lang/grayscale/issues/1953)) ([b27f4ed](https://github.com/grayscale-lang/grayscale/commit/b27f4ede1fe8ddda1219e8253a384c696d3e9a1f))
* **codegen:** eliminate double vsnprintf in emitf for short emissions ([#1952](https://github.com/grayscale-lang/grayscale/issues/1952)) ([aaa214d](https://github.com/grayscale-lang/grayscale/commit/aaa214d2866172055ce6a3227704125c9585a28d))
* **codegen:** replace linear scan in is_c_keyword with bsearch ([#1956](https://github.com/grayscale-lang/grayscale/issues/1956)) ([d2ac0a2](https://github.com/grayscale-lang/grayscale/commit/d2ac0a2c246ac4eda91621f8a95b68259ffdb936))
* **codegen:** replace malloc/free with stack buffer in NODE_MEMBER_EXPR ([#1911](https://github.com/grayscale-lang/grayscale/issues/1911)) ([eb2a80b](https://github.com/grayscale-lang/grayscale/commit/eb2a80b263f3f7ceb5341268a9d0d95dca0814de))
* eliminate O(n) inner loop in tc_lookup_using_constant via pre-computed import index ([#2041](https://github.com/grayscale-lang/grayscale/issues/2041)) ([ce92138](https://github.com/grayscale-lang/grayscale/commit/ce921380d323f847601c8cb8c343fb544db9a964))
* **error:** add cached error/warning counters to DiagnosticList ([#1943](https://github.com/grayscale-lang/grayscale/issues/1943)) ([b7ac109](https://github.com/grayscale-lang/grayscale/commit/b7ac10985b2a1ae5ff15bc6404c8c8072005bac6))
* **error:** build line-offset index in diag_set_source ([#1942](https://github.com/grayscale-lang/grayscale/issues/1942)) ([e0c5a5a](https://github.com/grayscale-lang/grayscale/commit/e0c5a5a7e2de5dde865c822935ae009a68f49476))
* **error:** replace single-file source cache with 4-slot LRU cache ([#1947](https://github.com/grayscale-lang/grayscale/issues/1947)) ([48ee72e](https://github.com/grayscale-lang/grayscale/commit/48ee72e1a1bc974d51a01c8a748690b6526451f1))
* fix several remaining memory leaks in typechecker and codegen ([5f513eb](https://github.com/grayscale-lang/grayscale/commit/5f513eb055c4511cea4da502c80f9fb974d77bcf))
* **imports:** limit rewrite_labels outer pass to original main-program nodes ([#1946](https://github.com/grayscale-lang/grayscale/issues/1946)) ([22b8643](https://github.com/grayscale-lang/grayscale/commit/22b864314f522771f5d226c2612584b8aa841936))
* **imports:** replace O(n) import-seen scan with FNV-1a open-addressing hash set ([#1951](https://github.com/grayscale-lang/grayscale/issues/1951)) ([8f5f9e2](https://github.com/grayscale-lang/grayscale/commit/8f5f9e2217fe4ef869b3db5801d20b2b86f0fdf4))
* **imports:** replace while+rescan with a pending import queue ([#1945](https://github.com/grayscale-lang/grayscale/issues/1945)) ([b073b80](https://github.com/grayscale-lang/grayscale/commit/b073b80d6eb830af533d0f45de682889565cbb31))
* replace 202 unconditional stack diagnostic buffers with arena allocation via tc_fmt helper ([#2044](https://github.com/grayscale-lang/grayscale/issues/2044)) ([287ec00](https://github.com/grayscale-lang/grayscale/commit/287ec00c0a1a618770de997617e0efa3df3ba274))
* replace strlen+sprintf heap allocs with snprintf into stack buffer in name-mangling paths ([#2045](https://github.com/grayscale-lang/grayscale/issues/2045)) ([1ee7731](https://github.com/grayscale-lang/grayscale/commit/1ee77310ecb043954076183602dcc228b0817d9b))
* **scan:** replace bubble sort in scan_ez_files with qsort ([#1944](https://github.com/grayscale-lang/grayscale/issues/1944)) ([1946c88](https://github.com/grayscale-lang/grayscale/commit/1946c888af092c5d2456947a02f9875121b9ea6d))
* **typechecker:** add hash index to type pool for O(1) lookup ([#1909](https://github.com/grayscale-lang/grayscale/issues/1909)) ([624a035](https://github.com/grayscale-lang/grayscale/commit/624a0352940d083eaa4a923fde3f8dbdbddeedef))
* **typechecker:** add hash table per scope for O(1) symbol lookup ([#1910](https://github.com/grayscale-lang/grayscale/issues/1910)) ([dd092e9](https://github.com/grayscale-lang/grayscale/commit/dd092e9ec2a9334d22d47830369a3621b2c3c1b9))
* **typechecker:** combine tc_is_using/tc_resolve_using into single-pass lookup ([#1912](https://github.com/grayscale-lang/grayscale/issues/1912)) ([b3a5ec2](https://github.com/grayscale-lang/grayscale/commit/b3a5ec2732bba2e66305857a7e9a6290439e4938))
* **typechecker:** replace is_struct_name and is_enum_name linear scans with sorted bsearch ([#1906](https://github.com/grayscale-lang/grayscale/issues/1906)) ([80fa62e](https://github.com/grayscale-lang/grayscale/commit/80fa62e98f78f3243d0ed49e57d9186818790325))
* **typechecker:** replace module and builtin name linear scans with bsearch ([#1908](https://github.com/grayscale-lang/grayscale/issues/1908)) ([2b3975e](https://github.com/grayscale-lang/grayscale/commit/2b3975ea3edfd4fb1e932b3e6c304e8e94d967f3))
* **typechecker:** replace O(n) scans in display name and enum helpers with bsearch ([#1948](https://github.com/grayscale-lang/grayscale/issues/1948)) ([ea19b7c](https://github.com/grayscale-lang/grayscale/commit/ea19b7cb70dc7c885c287b91d9f0f82c42e84acf))
* **typechecker:** replace O(n) scans in fallible stdlib lookups with bsearch ([#1949](https://github.com/grayscale-lang/grayscale/issues/1949)) ([521246d](https://github.com/grayscale-lang/grayscale/commit/521246d2002ddb3d3af85f70f0f255ec07d6c0b0))
* **typechecker:** replace strdup with arena_strdup in error paths ([#1904](https://github.com/grayscale-lang/grayscale/issues/1904)) ([06a68a3](https://github.com/grayscale-lang/grayscale/commit/06a68a36e6b1bc68884a8db68024cb6a5e965cd9))
* **typechecker:** sort stdlib arg tables and use bsearch for lookup ([#1907](https://github.com/grayscale-lang/grayscale/issues/1907)) ([486edbc](https://github.com/grayscale-lang/grayscale/commit/486edbc76703eb5aa2403385572bfe02477ad8a3))
* **typechecker:** sort stdlib lookup tables in typechecker_create ([#1955](https://github.com/grayscale-lang/grayscale/issues/1955)) ([b54a2f6](https://github.com/grayscale-lang/grayscale/commit/b54a2f67f3dd68883db645b4e0aa4784aef709b3))
* **typechecker:** use sorted bsearch for find_func ([#1905](https://github.com/grayscale-lang/grayscale/issues/1905)) ([93926c7](https://github.com/grayscale-lang/grayscale/commit/93926c7f98dd1670fca99f4cc45f416fe8a2899d))
* **typechecker:** use stack buffer in levenshtein to avoid malloc on every call ([#1950](https://github.com/grayscale-lang/grayscale/issues/1950)) ([75f9ed4](https://github.com/grayscale-lang/grayscale/commit/75f9ed4d87b98f81baafedd2b8847cf349feba23))


### Documentation

* add default field values to STANDARD.md struct section ([#1794](https://github.com/grayscale-lang/grayscale/issues/1794)) ([0a16079](https://github.com/grayscale-lang/grayscale/commit/0a16079347224bc0464e4c166c0fc23eb651b99c))
* add named arguments section to STANDARD.md ([#1840](https://github.com/grayscale-lang/grayscale/issues/1840)) ([dac3aed](https://github.com/grayscale-lang/grayscale/commit/dac3aed8b0489447273a6e751d0221a7112b1d67))
* **assert:** document assert() in STANDARD.md and ez man ([02691ba](https://github.com/grayscale-lang/grayscale/commit/02691ba7efecaa778b6a3177f6f65d6f82c6a9a1))
* clarify mutual struct recursion support in STANDARD.md §3.2.3 ([#1927](https://github.com/grayscale-lang/grayscale/issues/1927)) ([f6ca82c](https://github.com/grayscale-lang/grayscale/commit/f6ca82c363eacde6e4732dbd36d8e76447c644ef))
* clean func type examples in STANDARD.md ([45ceba6](https://github.com/grayscale-lang/grayscale/commit/45ceba6bc45c599cfe7a15dffc02d0a61eabedea))
* expand CLI command reference in STANDARD.md Section 13 ([#1889](https://github.com/grayscale-lang/grayscale/issues/1889)) ([10d3781](https://github.com/grayscale-lang/grayscale/commit/10d3781c77c7a8f4186a1613ef1b231deb3edde2))
* expand func type documentation in STANDARD.md section 7.6 ([635844d](https://github.com/grayscale-lang/grayscale/commit/635844d2720ae41032941ccae4cdd2c1ee992029))
* fix func reference variable examples to use const instead of mut ([c316ee5](https://github.com/grayscale-lang/grayscale/commit/c316ee59d81211ec78df83910f73955846f50d45))
* fix remove_key signature in STANDARD.md section 9.4 ([#1881](https://github.com/grayscale-lang/grayscale/issues/1881)) ([7d8b7a8](https://github.com/grayscale-lang/grayscale/commit/7d8b7a80ad60d30b6165025d2c98002615b613c3))
* fix stale E16001/E16002 references in TESTING.md, replace with correct E3006 ([#1973](https://github.com/grayscale-lang/grayscale/issues/1973)) ([1a27654](https://github.com/grayscale-lang/grayscale/commit/1a27654b4599c00261194b723e083a9e92deebba))
* fix static dispatch example in named arguments section ([#1840](https://github.com/grayscale-lang/grayscale/issues/1840)) ([9838f93](https://github.com/grayscale-lang/grayscale/commit/9838f9310f33cbfa075d6775f921dca07750f9ad))
* fix typo in README ([#1891](https://github.com/grayscale-lang/grayscale/issues/1891)) ([dc59e21](https://github.com/grayscale-lang/grayscale/commit/dc59e2147f9fd2c2b7b35c8594580bfb8f9e2dd7))
* modernize PR template ([6a2c838](https://github.com/grayscale-lang/grayscale/commit/6a2c8387fd18a226c4eca48feb94410e6cc89100))
* regenerate ERRORS.md from error_codes.h ([94cd818](https://github.com/grayscale-lang/grayscale/commit/94cd8186dd750d6950102daf24c3c0245f662519))
* regenerate ERRORS.md from error_codes.h ([cc5953f](https://github.com/grayscale-lang/grayscale/commit/cc5953fdcc9abb57a945fa8797ee18d085bc5605))
* regenerate ERRORS.md from error_codes.h ([e33689f](https://github.com/grayscale-lang/grayscale/commit/e33689f2317bb5dcf63eaee8e58f5e9c933dcffe))
* regenerate ERRORS.md from error_codes.h ([53cf06d](https://github.com/grayscale-lang/grayscale/commit/53cf06d742654ab68f19d83867adbe369844c1e4))
* regenerate ERRORS.md from error_codes.h ([217861c](https://github.com/grayscale-lang/grayscale/commit/217861c623179ce9607467f57342f2e90c5d8d41))
* regenerate ERRORS.md from error_codes.h ([d9b9c4a](https://github.com/grayscale-lang/grayscale/commit/d9b9c4ae0b4f1bba7d429338c64b0be999d172cf))
* regenerate ERRORS.md from error_codes.h ([1d53226](https://github.com/grayscale-lang/grayscale/commit/1d53226ab17054feb5cbce0a42c78a6e69ac6f97))
* regenerate ERRORS.md from error_codes.h ([a2aea0f](https://github.com/grayscale-lang/grayscale/commit/a2aea0fec0a5690a7f667357a068c924a014d686))
* regenerate ERRORS.md from error_codes.h ([3ce2b2b](https://github.com/grayscale-lang/grayscale/commit/3ce2b2b6418c9ddc646f320c445a516d10dfd2ef))
* regenerate ERRORS.md from error_codes.h ([2260cb5](https://github.com/grayscale-lang/grayscale/commit/2260cb5f5fa20a5fd08329e9abded5524f2421f1))
* regenerate ERRORS.md from error_codes.h ([9549a90](https://github.com/grayscale-lang/grayscale/commit/9549a90ab92377cfc8f7ca026d3e6ba50989feeb))
* regenerate ERRORS.md from error_codes.h ([dbd738e](https://github.com/grayscale-lang/grayscale/commit/dbd738e10535656006f81d7bbf756df405cd7ed6))
* regenerate ERRORS.md from error_codes.h ([e23f719](https://github.com/grayscale-lang/grayscale/commit/e23f719706bad8844c484a676e7c697fbbd9af00))
* regenerate ERRORS.md from error_codes.h ([ea3d0d4](https://github.com/grayscale-lang/grayscale/commit/ea3d0d481593b53b5aaf0534560d09081d1104d8))
* regenerate ERRORS.md from error_codes.h ([9ba294b](https://github.com/grayscale-lang/grayscale/commit/9ba294b73d5269a670ea70d3cb50f625350ff404))
* regenerate ERRORS.md from error_codes.h ([d840cad](https://github.com/grayscale-lang/grayscale/commit/d840cad3bfc3d9925999394a7da0d9c6740f4eb8))
* regenerate ERRORS.md from error_codes.h ([c7ba607](https://github.com/grayscale-lang/grayscale/commit/c7ba6072abf7ef8681e51134150e9859af7d938a))
* regenerate ERRORS.md from error_codes.h ([3879f2e](https://github.com/grayscale-lang/grayscale/commit/3879f2e9a9e6cc210aa9e73b55805419556dde3e))
* regenerate ERRORS.md from error_codes.h ([877c347](https://github.com/grayscale-lang/grayscale/commit/877c347edca2b937b9764f943fc2caa984f8685e))
* regenerate ERRORS.md from error_codes.h ([458f38e](https://github.com/grayscale-lang/grayscale/commit/458f38ec8a63784b9b1e5546b093f68865994356))
* regenerate ERRORS.md from error_codes.h ([055b4e8](https://github.com/grayscale-lang/grayscale/commit/055b4e806ff8dc8abf393022f262ca6e125b8e4a))
* regenerate ERRORS.md from error_codes.h ([608da36](https://github.com/grayscale-lang/grayscale/commit/608da3674167ec3f33905687c67854d2666fcbc1))
* STANDARD.md and README updates for Flip mascot and recursive structs ([33db793](https://github.com/grayscale-lang/grayscale/commit/33db79301706df087959d9bee955bdcad1a3fa9b))
* **standard:** document call-site pointer dereference for pointer-returning functions ([94b9a8c](https://github.com/grayscale-lang/grayscale/commit/94b9a8c43927aaf64ae704b66102bab4613fd9a6))
* **standard:** document implicit pointer deref in recursive struct traversal ([#1687](https://github.com/grayscale-lang/grayscale/issues/1687)) ([b056aa4](https://github.com/grayscale-lang/grayscale/commit/b056aa408e2957918f77266873725beab69e3883))
* **standard:** document inline pointer dereference on call results as Flip's Tip ([6b9be1f](https://github.com/grayscale-lang/grayscale/commit/6b9be1f667f4e4fffa085e33a73de5911fc058b2))
* **standard:** fix tagged enum when/is examples to use supported syntax ([#1970](https://github.com/grayscale-lang/grayscale/issues/1970)) ([a86990e](https://github.com/grayscale-lang/grayscale/commit/a86990eca5cdc1ba89ccb4a605f4a00b3dc60f97))
* **standard:** replace Note callouts with Flip's Tips ([5f36720](https://github.com/grayscale-lang/grayscale/commit/5f36720dbe743082a7cdf5bcf65ed96057845984))
* update CONTRIBUTING.md for Grayscale migration ([5dea9c2](https://github.com/grayscale-lang/grayscale/commit/5dea9c21ad33bb8aa5eb654ab164bf4f688ab64a))
* Update README.md & STANDARD.md ([1195a22](https://github.com/grayscale-lang/grayscale/commit/1195a2291257d23ab172487c16cc0a4329862980))
* Update README.md and STANDARD.md ([b176eff](https://github.com/grayscale-lang/grayscale/commit/b176eff65add11be11c9cc9ff32d85581d8e60ab))
* Update STANDARD.md ([3fcee06](https://github.com/grayscale-lang/grayscale/commit/3fcee0642f9f4a683b5b0d4aec1f920470791536))
* update TESTING.md count and entry for for loop blank identifier test ([c1c9904](https://github.com/grayscale-lang/grayscale/commit/c1c9904f1fdbd2c91a59f8c7f389644c95abff83))
* update TESTING.md fail test count to 686 ([#1844](https://github.com/grayscale-lang/grayscale/issues/1844), [#1845](https://github.com/grayscale-lang/grayscale/issues/1845), [#1846](https://github.com/grayscale-lang/grayscale/issues/1846)) ([37f2f0a](https://github.com/grayscale-lang/grayscale/commit/37f2f0a4e429b1f5bff6a77d7b3bb75b5e783c35))
