...
- `integration-tests/pass/core/` — 246 core language feature tests covering arrays, control flow, structs, enums, maps, pointers, named returns, type inference, builtins, C interop, bigint types, wildcards, and more.
...
- `integration-tests/fail/errors/` — 757 error detection tests covering all compiler error codes (E1xxx–E9xxx) and runtime panics.
