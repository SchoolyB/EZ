...
- `integration-tests/pass/core/` — 104 core language feature tests (arrays, control flow, structs, enums, maps, typeof, named returns, import variants, C interop, etc.)
...
- `integration-tests/fail/errors/` — 420 error detection tests
