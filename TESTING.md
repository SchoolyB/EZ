...
- `integration-tests/pass/core/` — 105 core language feature tests (arrays, control flow, structs, enums, maps, typeof, named returns, import variants, C interop, #strict when, etc.)
- `integration-tests/pass/stdlib/` — 26 stdlib module tests
...
- `integration-tests/fail/errors/` — 424 error detection tests
