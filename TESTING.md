...
- `integration-tests/pass/core/` — 115 core language feature tests (arrays, control flow, structs, enums, maps, typeof, named returns, import variants, C interop, #strict when, or_return, raw strings, bigint arrays, pointer collections, non-standard map key ops, wide numeric map keys, [func] arrays, etc.)
...
- `integration-tests/fail/errors/` — 431 error detection tests
