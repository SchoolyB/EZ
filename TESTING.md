...
- `integration-tests/pass/core/` — 118 core language feature tests (arrays, control flow, structs, enums, maps, typeof, named returns, import variants, C interop, #strict when, or_return, raw strings, bigint arrays, pointer collections, non-standard map key ops, wide numeric map keys, [func] arrays, func var calls, enum map keys, map deep copy, etc.)
...
- `integration-tests/fail/errors/` — 434 error detection tests
