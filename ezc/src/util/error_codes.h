...
#define EZ_LEXER_ERRORS \
    ...
    EZ_ERROR("E1012", "syntax", "numbers cannot start with an underscore") \
...
#define EZ_PARSER_ERRORS \
    ...
    EZ_ERROR("E2010", "syntax", "cannot use a module before importing it; add the import at the top of the file") \
    ...
    EZ_ERROR("E2015", "syntax", "duplicate field in this struct; each field can only be initialized once") \
    EZ_ERROR("E2016", "syntax", "empty enum; add at least one variant") \
    ...
    EZ_ERROR("E2067", "syntax", "empty struct; add at least one field") \
...
#define EZ_TYPE_ERRORS \
    ...
    EZ_ERROR("E3005", "types", "cannot change a constant; use 'mut' instead of 'const' to modify this value") \
    EZ_ERROR("E3006", "types", "return value mismatch; this function returns a value it shouldn't, or is missing a required return") \
    EZ_ERROR("E3007", "types", "++ and -- only work on integers; this operand is not an integer") \
    ...
    EZ_ERROR("E3011", "types", "type name used as a value; did you forget to declare a variable?") \
    ...
    EZ_ERROR("E3040", "types", "this function returns multiple values but only one is being assigned; use mut a, b = func()") \
...
#define EZ_STDLIB_ERRORS \
    ...
    EZ_ERROR("E12006", "stdlib", "duplicate key in map; each key must be unique")
